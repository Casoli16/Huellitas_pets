...
window.onload = async function () {
    try {
            ...
            try {
                ...
                if (DATA2.status) {
                    ...
                    if (resultado == HASH) {
                        ...
                        PERMISO = 0;
                        sweetAlert(2, 'Este enlace ya no está disponible, ingresa al último correo recibido de recuperación de contraseña.', false);
                    }
                } else {
                    PERMISO = 0;
                ...
                PERMISO = 0;
                console.error(error);
                sweetAlert(2, 'Ocurrió un error al verificar el enlace. Por favor, intenta de nuevo.', false);
            }
        }
        ...
        BOTON.addEventListener('click', async (event) => {
            ...
            if (INPUT1.value === INPUT2.value) {
                ...
                try {
                    ...
                    console.error(error);
                    sweetAlert(2, 'Ocurrió un error al actualizar la contraseña. Por favor, intenta de nuevo.', false);
                }
            } else {
        ...
        console.error('Error en la carga inicial de la página:', error);
        sweetAlert(2, 'Ocurrió un error al cargar la página. Por favor, intenta de nuevo.', false);
    }
};
